...
Całkowite roczne oszczędności =
  (Zredukowane godziny administracyjne × 55 USD/godz. średnia stawka obciążona)
  ...
  + (Wyeliminowane zdarzenia sporne × 5 400 USD średni koszt rozwiązania)
**Uproszczony przykład obliczeniowy** (szacowany na podstawie typowych wskaźników średniej wielkości dostawcy dla lotnictwa):
