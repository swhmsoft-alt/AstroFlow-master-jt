...
For components operating below 300Â°C, any titanium grade can be used without concern for creep or oxidation. Above 300Â°C, the selection narrows. CP grades begin to lose strength above approximately 300Â°C, and Ti-6Al-4V is limited to approximately 400Â°C for prolonged service.

Near-alpha alloys such as Ti-6242 are designed for service up to 540Â°C. Above 540Â°C, titanium alloys in general are limited by oxidation rate rather than creep strength. The alpha case formation that occurs at elevated temperatures in air becomes a design consideration above approximately 400Â°C and must be accounted for in the machining allowance if the component is machined after heat treatment.
...
Third, check the operating temperature range. If the service temperature exceeds 400Â°C for prolonged periods, near-alpha alloys such as Ti-6242 are required. If the component will be used at cryogenic temperatures, select an alpha or CP grade with verified low-temperature ductility.
...
| Service above 400Â°C | Ti-6242 | Ti-6Al-4V | Brief or infrequent temperature excursions |
