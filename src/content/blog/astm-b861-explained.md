---
title: "ASTM B861 Explained: Titanium and Titanium Alloy Seamless Pipe"
slug: astm-b861-explained
...
| Schedule | Typical wall thickness (2-inch NPS) | Common applications |
| --- | --- | --- |
| Sch 5S | 2.77 mm | Low-pressure, weight-sensitive piping |
| Sch 10S | 3.91 mm | General corrosion-resistant process piping |
| Sch 40S | 5.54 mm | Moderate pressure chemical and seawater systems |
| Sch 80S | 8.74 mm | High-pressure and structural piping |
...
| Grade | UTS (MPa, min) | YS (MPa, min) | Primary service environment |
| --- | --- | --- | --- |
| Grade 1 | 240 | 170 | Maximum corrosion resistance, low strength |
| Grade 2 | 345 | 275 | Seawater, brine, chemical process |
| Grade 7 | 345 | 275 | Reducing acids, chlorides |
| Grade 12 | 483 | 345 | Moderate reducing environments |
| Grade 5 | 895 | 828 | High-strength pressure applications |
...
| Factor | ASTM B861 seamless | ASTM B862 welded |
| --- | --- | --- |
| Manufacturing | Extruded or pierced | Longitudinally welded strip |
| Pressure rating | Higher for same schedule | Slightly lower, weld-dependent |
| Corrosion sensitivity | No weld seam | Weld and heat-affected zone |
| Availability | More limited large sizes | Better availability in large diameters |
| Relative cost | Higher | Lower |
| Typical use | High-pressure, critical service | Low to moderate pressure piping |
...
For technical support specifying ASTM B861 seamless pipe, including grade selection, schedule sizing, and fabrication planning, submit your requirements through the [RFQ portal](/rfq/). A [titanium fabrication and machining partner](/titanium-cnc-machining-manufacturer/) can assist with pipe spool fabrication, welding, and final assembly.

<!-- VISUAL CONTENT BRIEF (for content planning only — NOT rendered on page)

## Fig 1 — ASTM B861 Pipe Schedule and Wall Thickness Chart

A bar chart showing wall thickness for common schedules across nominal pipe sizes from 1/2 inch to 12 inches. Bars labeled with Sch 5S, Sch 10S, Sch 40S, Sch 80S. Supports queries about "ASTM B861 pipe dimensions" and "titanium pipe schedule wall thickness."

## Fig 2 — Grade Selection Map for Corrosive Services

A service-environment matrix mapping fluid types to recommended ASTM B861 grades. Rows include seawater, hydrochloric acid, sulfuric acid, chloride brine, and oxidizing chemicals. Supports queries about "which titanium grade for seawater pipe" and "ASTM B861 grade selection."

## Fig 3 — Seamless vs Welded Pipe Installation Comparison

A side-by-side process diagram showing installation steps for seamless and welded titanium pipe, highlighting welding qualification, inspection, and support spacing differences. Supports queries about "titanium seamless vs welded pipe installation" and "ASTM B861 vs B862."
