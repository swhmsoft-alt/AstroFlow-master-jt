---
title: "ASTM B338 Titanium Tubing Standard Explained"
slug: astm-b338-explained
...
| Grade | Key alloying addition | Corrosion environment | Typical tubing use |
| --- | --- | --- | --- |
| Grade 1 | None (CP Ti) | Mildly reducing to oxidizing | Maximum formability, thin-wall tubing |
| Grade 2 | None (CP Ti) | Seawater, brackish water, chlorides | Condensers, heat exchangers |
| Grade 7 | Pd addition | Reducing acids, chlorides | Chemical process tubing |
| Grade 12 | Mo, Ni addition | Moderate reducing environments | Power plant, industrial heat exchangers |
| Grade 5 | Al, V alloy | Less aggressive, strength-critical | High-pressure tubing, aerospace |
...
| Grade | UTS (MPa, min) | YS (MPa, min) | Elongation (%) |
| --- | --- | --- | --- |
| Grade 2 | 345 | 275 | 20 |
| Grade 7 | 345 | 275 | 20 |
| Grade 9 | 620 | 485 | 15 |
...
For assistance specifying ASTM B338 tubing for heat exchangers, condensers, or process systems, submit your requirements through the [RFQ portal](/rfq/). A [titanium fabrication partner](/titanium-cnc-machining-manufacturer/) can support tube bending, welding, and final assembly in addition to material supply.

<!-- VISUAL CONTENT BRIEF (for content planning only — NOT rendered on page)

## Fig 1 — ASTM B338 Tubing Grade Selection Decision Tree

A flowchart starting from "corrosion environment" and "strength requirement" branches to recommended grades: Grade 2 for seawater condensers, Grade 7 for reducing acids, Grade 5 for high-pressure structural. Supports queries about "which titanium grade for heat exchanger tubing" and "ASTM B338 grade selection."

## Fig 2 — Seamless vs Welded Tubing Comparison Matrix

A matrix comparing seamless and welded ASTM B338 tubing across cost, availability, pressure capability, corrosion sensitivity, and typical applications. Supports queries about "titanium seamless vs welded tubing" and "ASTM B338 welded tubing."

## Fig 3 — Tube Failure Mode Diagram

An annotated diagram of a heat-exchanger tube showing common failure locations: crevice under support, galvanic joint, erosion-corrosion zone. Labels explain root causes and prevention. Supports queries about "titanium tubing corrosion" and "titanium heat exchanger tube failure."
