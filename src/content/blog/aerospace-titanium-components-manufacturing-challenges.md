...
|-------------|---------------------|-------------------|
| Wall thickness | 1.0—?.0 mm | Toolpath strategy, multiple semi-finishing passes |
| Tolerance | ±0.05—?.10 mm standard; ±0.025 mm critical | Thermal management, in-process probing |
