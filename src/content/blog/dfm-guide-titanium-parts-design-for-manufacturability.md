...
|---------------|---------------------|--------|
| Internal corner radius | 1.5–2.0x tool diameter | Allows larger, more rigid tools |
| Pocket depth | ≤4x pocket width | Avoids extended tool issues |
| Wall thickness transitions | Tapered, 1–3° | Reduces thermal distortion |
| Hole type | Through-hole preferred | Improves chip evacuation |
| Thread engagement | 1.5–2.0x bolt diameter | Ensures adequate thread strength |
