...
|-----------|----------------------|-----------------|-----------------|
| Roughing | 1.6–0.2 | Tool wear, vibration | Depth of cut, rigidity |
| Semi-finishing | 0.8–0.6 | Built-up edge | Speed selection |
| Finishing, standard | 0.4–0.8 | Nose radius, feed | Tool geometry selection |
| Finishing, precision | 0.2–0.4 | Vibration, built-up edge | Coolant, tool condition |
| Polishing (post-machining) | 0.05–0.2 | Abrasive selection | Grit progression |

---

**Table 2: Parameter effects on surface finish in titanium**

| Parameter | Typical range for Ra –0.4 μm | Effect on surface | Trade-off |
|-----------|------------------------------|-------------------|-----------|
| Feed rate | 0.05–0.10 mm/rev | Directly sets scallop height | Lower feed increases cycle time |
| Nose radius | 0.4–0.8 mm | Larger radius = smoother surface | Larger radius increases forces |
