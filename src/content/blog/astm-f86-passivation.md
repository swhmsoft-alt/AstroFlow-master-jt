---
title: "ASTM F86 Passivation: Surface Treatment Requirements for Titanium"
slug: astm-f86-passivation
...
ASTM F86 is not a materials specification. It does not define alloy composition or mechanical properties. Instead, it is a process standard. The same titanium alloy may be processed by different passivation methods depending on whether the final use is orthopedic, dental, spinal, or industrial. For more on achieving controlled titanium surface finishes, see the [titanium surface finish guide](/blog/titanium-surface-finish-achieving-ra-04um/).
...
| Method | Purpose | Risk if poorly executed |
| --- | --- | --- |
| Ultrasonic cleaning | Remove oils and particulates | Incomplete cleaning leaves residues |
| Alkaline cleaning | Remove organic films | Inadequate rinsing causes staining |
| Pickling | Remove oxide scale and alpha case | Over-etching changes dimensions |
| Nitric acid passivation | Stabilize oxide film | Wrong chemistry leaves contaminants |
| Deionized water rinse | Remove acid residues | Tap water minerals deposit on surface |
...
| --- | --- | --- |
| Water-break test | Hydrophobic residues, oils | In-process inspection after cleaning |
| Copper sulfate test | Embedded iron particles | After passivation, for free iron detection |
| SEM / EDS | Surface morphology and chemistry | Process validation and failure analysis |
| Potentiodynamic polarization | Corrosion behavior | Validation of passive film quality |
| Cytotoxicity testing | Biological response | Final implant validation |
...
For ASTM F86 passivation of titanium medical or industrial components, including process validation, documentation, and clean packaging, submit your requirements through the [RFQ portal](/rfq/). A [titanium surface treatment partner](/titanium-cnc-machining-manufacturer/) can integrate passivation with precision machining and final inspection.

<!-- VISUAL CONTENT BRIEF (for content planning only — NOT rendered on page)

## Fig 1 — ASTM F86 Titanium Passivation Process Flow

A horizontal process flow diagram showing cleaning, pickling, nitric acid passivation, rinsing, drying, and verification testing. Each step includes key process parameters and common failure modes. Supports queries about "ASTM F86 passivation process" and "titanium passivation steps."

## Fig 2 — Surface Oxide Film Formation Diagram

A cross-section illustration of the titanium surface showing native oxide layer, contaminants, and the effect of passivation in producing a dense TiO2 film. Labels explain how embedded iron creates galvanic sites. Supports queries about "titanium passivation oxide layer" and "ASTM F86 titanium surface."

## Fig 3 — Verification Test Decision Matrix

A matrix mapping component type and risk level to recommended verification tests: water-break, copper sulfate, SEM/EDS, polarization, cytotoxicity. Supports queries about "ASTM F86 acceptance testing" and "titanium passivation test methods."
