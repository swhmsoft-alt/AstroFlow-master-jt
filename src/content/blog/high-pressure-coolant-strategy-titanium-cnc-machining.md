...
|---------------|-------------|-----------------|-------------------------------|---------------------|
| 5–10 bar (flood) | Marginal at cutting edge | Poor in deep features | Baseline | Standard coolant system |
| 10–30 bar | Moderate | Limited | 10–20% | Enhanced pump, standard tooling |
| 30–50 bar | Good | Effective for shallow features | 20–40% | Through-spindle tooling |
| 50–80 bar | Good | Effective for most features | 40–60% | Sealed tool holders, filtration |
| 80–100+ bar | Excellent | Effective for deep features | 60–80% | Specialist tooling, fine filtration |
...
|-----------|-------------|---------------------|--------------------------|
| Concentration | 8–10% volume | Daily | Reduced lubricity, tool life drop |
| Temperature | 25–30°C | Continuous (chiller) | Progressive tool life reduction |
| Tramp oil | Below 1% | Weekly | Reduced wetting, bacterial growth |
| Filtration | 20–50 microns | Weekly filter check | Seal damage, nozzle blockage |
| pH | 8.5–9.5 | Weekly | Corrosion risk, bacterial growth |
