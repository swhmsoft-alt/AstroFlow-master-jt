---
title: Titanium Grades Complete Guide — CP, Alpha, Alpha-Beta, and Beta Alloys Explained
...
- [Commercially pure grades — when strength is not the priority](#commercially-pure-grades--when-strength-is-not-the-priority)
- [Alpha and near-alpha alloys — creep resistance at elevated temperatures](#alpha-and-near-alpha-alloys--creep-resistance-at-elevated-temperatures)
- [Alpha-beta alloys — the workhorse category](#alpha-beta-alloys--the-workhorse-category)
- [Beta alloys — high strength for specialized applications](#beta-alloys--high-strength-for-specialized-applications)
...
|----------|---------------|------------------------|-------------------|-------------------|
| Commercially pure | Grade 1–4 | 240–550 MPa | Corrosion resistance, formability | Low strength |
| Alpha/Near-alpha | Ti-6242, Ti-5Al-2.5Sn | 800–950 MPa | High-temperature creep resistance | Lower room-temperature strength |
| Alpha-beta | Ti-6Al-4V (Grade 5), Grade 23 | 900–1200 MPa | Balanced properties, most widely used | Not optimized for any single property |
| Beta | Ti-1023, Ti-15-3 | 1200–1400 MPa | Highest strength | Difficult to machine, higher cost |
...
Fig 2 — Strength vs ductility by grade category: A scatter plot with tensile strength on the x-axis and elongation on the y-axis, showing the position of each grade category. CP grades cluster at low strength/high ductility, beta alloys at high strength/low ductility, alpha-beta in the middle. Supports queries about trade-offs in titanium grade selection.
Fig 3 — Application-to-grade mapping matrix: A grid with industries on one axis and grade categories on the other, with cells marked to indicate typical matches. Color coding shows frequency of use. Supports queries about which titanium grade to use for specific applications.
-->
