---
title: "ASTM B381 Explained: Titanium and Titanium Alloy Forgings"
slug: astm-b381-explained
...
**Table 1: ASTM B381 forging class requirements**
...
**Table 2: Typical Grade 5 forging properties by condition**
...
For a technical review of your forging requirements, including class selection, heat treatment, and inspection planning, submit your drawings and specifications through the [RFQ portal](/rfq/). A [specialized titanium machining and forging partner](/titanium-cnc-machining-manufacturer/) can help align the forging specification with downstream CNC machining and finishing operations.

<!-- VISUAL CONTENT BRIEF (for content planning only — NOT rendered on page)

## Fig 1 — Forging Class Selection Flowchart

A decision tree showing component loading condition leading to Class I or Class II selection. Includes examples: shaft → Class I, compressor disc → Class II. Labels show required test orientations. Supports queries about "ASTM B381 Class I vs Class II" and "when to specify transverse properties in titanium forgings."

## Fig 2 — Forged vs Machined-from-Solid Cost Comparison Matrix

A matrix comparing forging and machining-from-solid across material utilization, lead time, tooling cost, and fatigue performance for low-volume and high-volume scenarios. Supports queries about "titanium forging vs machining cost" and "when to choose titanium forging."

## Fig 3 — ASTM B381 Forging Microstructure and Grain Flow Diagram

A cross-sectional diagram of a forged ring showing grain-flow lines following the contour. Annotated labels explain how grain orientation affects longitudinal and transverse properties. Supports queries about "titanium forging grain flow" and "forging mechanical properties direction."
