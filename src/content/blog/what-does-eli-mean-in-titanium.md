---
title: "What Does ELI Mean in Titanium? Extra-Low Interstitial Grades Explained"
slug: what-does-eli-mean-in-titanium
...
ELI — Extra Low Interstitial — is a material modification designation applied to titanium alloys and commercially pure (CP) titanium grades that have been produced with tighter-than-standard control of interstitial elements: oxygen, nitrogen, carbon, and hydrogen. The ELI designation signals that the material has a measurably lower interstitial content than its standard counterpart, which translates into improved ductility, fracture toughness, and fatigue crack growth resistance. ELI titanium is not a single grade — it is a modification available across multiple compositions, each with its own applicable standard and its own engineering rationale. The most widely specified ELI grade is [Grade 23 (Ti-6Al-4V ELI)](/materials/grade-23/) per ASTM F136, but ELI variants of CP-Ti Grade 4 (per ASTM F67) and, in some specifications, Grade 2 and Grade 3 are also available. Understanding which ELI grades exist, what property differences the ELI modification actually produces, and when the premium over standard-grade material is justified is essential for any engineer or procurement professional sourcing titanium for medical implants, cryogenic equipment, or fracture-critical aerospace components. For a complete overview of all titanium alloy categories, see the [titanium grades complete guide](/blog/titanium-grades-complete-guide-cp-alpha-beta-alloys/). For the medical-specific context, see the [ASTM F136 standard guide](/blog/astm-f136-titanium-standard-surgical-implants-guide/) and the [Grade 23 titanium guide](/blog/grade-23-titanium-ti-6al-4v-eli-medical-aerospace/).
...
For engineering teams evaluating titanium material specifications for medical, cryogenic, or fracture-critical applications, confirming that the ELI designation is justified by the actual service conditions — and verifying that the supplier can provide material certified to the correct standard with EN 10204 Type 3.1 documentation — will prevent the most common specification errors. A [titanium CNC machining and fabrication supplier](/titanium-cnc-machining-manufacturer/) with documented experience across all ELI grades can provide the material procurement support and certification verification needed.

For a quotation on ELI-grade titanium components with correct standard designation and full certification, submit your requirements through our [RFQ portal](/rfq/).

---

<!-- VISUAL CONTENT BRIEF (for content planning only — NOT rendered on page)

## Fig 1 — ELI Titanium Grades Overview Diagram

A matrix chart showing all titanium grades (vertical axis: Grade 1 through Grade 23) against their ELI availability (horizontal axis: "Standard Only," "ELI Variant Available," "Primary ELI Grade"). Grade 23 is highlighted as "Primary ELI Grade." ELI Grade 4 and ELI Grade 3 are marked as "Available." Supports queries about "which titanium grades have ELI variants" and "list of ELI titanium grades."

## Fig 2 — Oxygen Content vs Mechanical Properties Line Chart

A dual-axis line chart with oxygen content (0.10–0.40 percent) on the x-axis, tensile strength on the left y-axis, and elongation on the right y-axis. The oxygen limits for each standard grade and ELI variant are marked with vertical dashed lines. The chart shows that each 0.01 percent oxygen increases strength by ~8 MPa and decreases elongation by ~0.5 percent. Supports queries about "effect of oxygen on titanium properties" and "why oxygen matters in titanium."

## Fig 3 — ELI vs Standard Grade KIC Comparison Bar Chart

A grouped bar chart showing fracture toughness ranges for Grade 5 vs Grade 23 ELI, standard Grade 4 vs ELI Grade 4, and standard Grade 3 vs ELI Grade 3 (if available). The 30–40 percent KIC improvement for Grade 23 versus Grade 5 is the dominant visual feature. A dashed reference line at 50 MPa√m marks the typical minimum for implant applications. Supports queries about "ELI vs standard titanium fracture toughness" and "why ELI titanium is tougher."
