---
title: "Titanium Dosing Pump Impeller"
sku: "TI-ENV-PUM-DOSING"
category: "Pump"
...
function: "Chemical dosing pump impeller (Grade 5)"
aliases: ["Pump impeller","Dosing impeller","Chemical impeller"]
pubDate: "2026-07-18"
---
...
- **SKU/Part Number Series:** TI-ENV-PUM-DOSING
...
| :--- | :--- | :--- |
| **Component Category** | Pump | Environmental Engineering Industry Classification |
...
- **Residual Stress Mitigation:** Every titanium dosing pump impeller batch undergoes post-machining vacuum stress-relieving annealing at 540-675°C for 1-2 hours under argon atmosphere (O₂ < 50 ppm) to eliminate residual tensile stresses induced by CNC material removal. This thermal cycle reduces microstructural distortion risk by >70% and prevents premature **stress corrosion cracking (SCC)** during field service. All threaded features are produced via **thread rolling** (not thread cutting), which induces compressive residual stresses at the thread root and maintains uninterrupted grain flow — increasing fatigue strength by 30-50% compared to cut threads. ISO 965-2 Class 6g tolerance is verified with calibrated Go/No-Go ring gauges on 100% of production.

---

### 5. Technical FAQ for System Engineers

#### Q1: What is the typical application for titanium dosing pump impeller?
- **A1:** Titanium Dosing Pump Impeller is designed for chemical dosing pump impeller (grade 5). The Grade 2 CP-Ti grade is selected to provide the optimal balance of strength, fatigue life, and environmental resistance for this specific application.

#### Q2: How is titanium dosing pump impeller manufactured?
- **A2:** Titanium Dosing Pump Impeller is manufactured using Powder sintering. Critical process controls include tool path optimization, coolant temperature management, and dimensional verification at each operation.
