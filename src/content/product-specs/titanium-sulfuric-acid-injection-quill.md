...
- **Non-Destructive Testing (NDT):** Components undergo PMI via OES analyzer per ASTM E1476 and hardness traverse per ASTM E18.3; PMI per ASTM E1476; Dimensional CMM; 100% wall thickness UT per ASTM A578 to guarantee zero sub-surface voids, micro-cracks, or structural anomalies. Threaded features verified with Go/No-Go ring gauges (Class 6g) per DIN 13-1 / ISO 965-2.
