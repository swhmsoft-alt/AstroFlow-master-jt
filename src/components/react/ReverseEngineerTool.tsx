...
const PART_DB: PartProfile[] = [
  ...
  },
  {
    ...
    pitfalls: ['Impeller blade-to-shaft weld must be full-penetration, verified by UT', 'Surface finish inside reactor vessels must be Ra<3.2um to prevent product buildup', 'Alpha case embrittlement: hot-forged Ti parts must be vacuum heat treated or HF+HNO3 pickled to remove >0.1mm brittle surface skin'],
    specNote: 'ASTM B265 Grade 12 plate, stress-relieved, 100% weld inspection (PT/UT), material cert 3.1, vacuum heat treated per AMS 2750',
    servicePage: '/titanium-fabrication-services/titanium-welding-assembly/',
    image: '🧪',
  },
  {
  ...
  },
  {
    ...
    painPoints: ['Hydrogen embrittlement from cathodic protection systems (zinc anodes)', 'Seawater crevice corrosion in hot stagnant zones >60C', 'Galvanic corrosion at steel-to-titanium interfaces', 'Biofouling-induced pitting under marine growth', 'Stress corrosion cracking in H2S/CO2 sour environments'],
    alloyId: 'tc4',
    alloyReason: 'Grade 5 (Ti-6Al-4V) for propellers, shafts, and structural components. Grade 5 ELI for deep-sea pressure vessels requiring maximum fracture toughness. Grade 7 (Pd alloy) for hot chemical injection lines. Grade 29 (Ru-enhanced) for severe sour service. Alloys must be vacuum-annealed to keep interstitial hydrogen <125ppm per ASTM B348.',
    formId: 'bar',
    formReason: 'Bar/forging stock for shafts and structural components. Investment casting for impeller blades. Ring forgings for flanges. All marine fasteners must be hot-headed + thread rolled with vacuum annealing for hydrogen embrittlement resistance.',
  ...
  },
  {
    ...
    specNote: 'ASTM B348 Grade 5, rolled threads (DIN 13-1 / ISO 965-2, 6g tolerance), Torx T25 drive, 100% MPI crack + 6g Go/No-Go ring gauge, PVD coated per ISO 27874 (1.5um), ASTM F86 passivated + Class 100 UCN',
    servicePage: '/titanium-cnc-machining-services/custom-industrial-components/',
    image: '🚲',
  },
  {
    ...
    painPoints: ['High thermal load up to 300C at rotor causing fluid boil', 'Brake fluid overheating from heat conducted through pistons', 'Pad contamination from corroded retaining pins', 'Weight on rotating unsprung mass', 'Thread galling in aluminum calipers', 'Rotor bolt shear failure under extreme braking torque'],
    alloyId: 'tc4',
    alloyReason: 'Grade 5 (Ti-6Al-4V) offers high shear strength for rotor bolts, ultra-low thermal conductivity (7 W/mK vs 105 for Al) to insulate brake fluid — critical for preventing brake fade on long descents. Caliper piston Ti-inserts act as thermal barriers. All safety-critical bolts must use rolled threads (never cut) for 300% higher fatigue life.',
    formId: 'plate',
    formReason: 'Plate stock for rotor machining. Bar stock for bolts, piston inserts, banjo fittings, and bleed screws. SLM 3D printing for flat-mount brake adapters with optimized topology. All bolts: forged + thread rolled (cut threads rejected).',
    process: ['CNC machining of rotor profile/brake track', 'Precision turning of caliper piston Ti-inserts', 'Hot forging + thread rolling of all rotor & caliper bolts', 'SLM 3D printing of flat-mount brake adapters', 'Mirror polishing of piston thermal barrier faces'],
    ...
    specNote: 'ASTM B348 Grade 5, rolled threads (DIN 13-1 / ISO 965-2, 6g), T25 Torx, 100% MPI + 6g ring gauge + pressure tested, PVD coated per ISO 27874 (1.5um), ASTM F86 passivated',
    servicePage: '/titanium-cnc-machining-services/cnc-milling-turning/',
    image: '🛑',
  },
  {
    ...
    painPoints: ['Unsprung mass reducing damper response', 'Pivot bearing preload consistency', 'Shock coil weight (steel is 500g+)', 'Linkage bolt fatigue under bottom-out loads', 'Derailleur hanger alignment for 12-speed', 'Bearing retainer ring rusting/seizing in pivot'],
    alloyId: 'tc4',
    alloyReason: 'Grade 5 (Ti-6Al-4V) for axles, bolts, hangers, and bearing retainers. Beta-C titanium for rear shock coils — shear modulus ~42 GPa enables 40-50% weight saving vs steel with superior fatigue life. Grade 9 for bearing spacer sleeves requiring crush resistance. ELI Grade 23 for SLM 3D-printed flex-stay plates requiring infinite structural flex-fatigue life.',
    formId: 'bar',
    formReason: 'Bar stock for pivot axles and linkage hardware. Beta-C wire for shock coil winding — cold coiled + vacuum aged. SLM 3D printing of flex-stay plates and hangers using Grade 23 ELI powder under argon (O2 <0.1%). Precision stamping + wire EDM for bearing retainer circlips.',
    process: ['CNC gun drilling + centerless grinding of pivot axles', 'Beta-C wire cold coiling + shot peening + preset for shock springs', 'SLM 3D printing of flex-stay plates with argon shielding', 'Hot forging + thread rolling of linkage bolts', 'Wire EDM of bearing retainer rings from cold-rolled beta strip'],
  ...
  {
    keywords: ['vacuum', '真空', 'chamber', '腔体', 'UHV', 'cleanroom', 'semiconductor', 'bracket', 'hinge', 'mount', 'shield', 'spacer', 'cable'],
    industries: ['Semiconductor'],
    category: 'Semiconductor Vacuum Chamber Structural Hardware',
    geometry: 'Precision-machined brackets, alignment dowel blocks, heavy-duty hinges, gas box manifold plates, cable guide links, turbo pump isolation saddles, heat shield spacers, 3D-printed cable routing pods',
    painPoints: ['Thermal distortion from bake-out cycles (150-200C)', 'Fugitive corrosive gas attack on external hardware', 'Particle shedding from plated steel fasteners', 'Magnetic interference from ferrous components near e-beam paths', 'Virtual leaks from trapped air pockets in blind bolt holes'],
    alloyId: 'tc4',
    alloyReason: 'Grade 5 (Ti-6Al-4V) for structural brackets, hinges, and saddles requiring high strength and low thermal conductivity. Grade 2 (CP-Ti) for non-structural plates and cable guides requiring zero outgassing and complete corrosion resistance.',
    formId: 'bar',
    formReason: 'Bar/plate stock for structural components via CNC machining. SLM 3D printing for complex cable-routing pods and irregular bracket geometries to minimize material waste and lead time.',
    process: ['CNC milling/turning of brackets and alignment blocks', 'SLM 3D printing of complex pod geometries', 'Thread rolling of all fasteners', 'Electropolishing + Class 100 ultrasonic cleaning'],
    tollServices: ['Helium leak testing (1x10^-9 mbar.L/s)', 'Outgassing rate measurement (ASTM E595)', 'CMM dimensional inspection (+-0.01mm)', 'Surface roughness measurement (Ra<0.4um)'],
    pitfalls: ['All threaded blind holes must be center-vented or flat-milled to prevent virtual leaks under UHV', 'Surface iron contamination from standard carbide tooling requires nitric acid passivation (ASTM F86) before cleanroom entry'],
    specNote: 'ASTM B348 Grade 5 / ASTM B265 Grade 2, electropolished, Class 100 UCN cleaned, MTC traceable to melt source',
    servicePage: '/titanium-cnc-machining-services/custom-industrial-components/',
    image: '🌀',
  },
  {
    keywords: ['VCR', 'fitting', 'gland', 'gas', 'gas line', 'ultra-high purity', 'UHP', 'manifold', 'check valve', 'orifice', 'restrictor', 'quick disconnect', '半导体', '气体'],
    industries: ['Semiconductor', 'Chemical Processing'],
    category: 'UHV Gas Delivery Fittings & Manifolds',
    geometry: 'VCR male glands and female nuts, micro-gaskets, double-ferrule compression sleeves, multi-port gas mixing monoblocks, check valve plungers, laser-drilled micro-orifice disks, quick-disconnect couplers, Y-shaped splitter connectors',
    painPoints: ['Trace metal ion leaching from stainless steel (Fe/Ni/Cr contamination of wafer)', 'Thread galling in Ti-to-Ti VCR connections under high torque', 'Dead zones in gas path causing toxic gas polymerization', 'Ferrule over-compression cracking thin-wall Ti tubing', 'Gasket creep relaxation causing micro-leaks after thermal cycling'],
    alloyId: 'cp2',
    alloyReason: 'Grade 2 (CP-Ti) ultra-pure vacuum melt for VCR glands and gaskets — zero trace metal outgassing. Grade 5 for female nut couplings and check valve plungers requiring high thread strength and cyclic fatigue life.',
    formId: 'bar',
    formReason: 'Bar stock for VCR components and manifold blocks via CNC turning/boring. Laser drilling for micro-orifice disks. Hot forging + machining for Y-shaped splitters to maintain smooth internal transitions.',
    process: ['CNC turning of VCR male/female components', 'Deep-hole boring of multi-port manifolds', 'Laser micro-drilling of orifice disks', 'Electropolishing of all wetted surfaces'],
    tollServices: ['Helium leak testing (1x10^-9 mbar.L/s)', 'PMI verification of all material', 'Surface roughness inspection (Ra<0.2um)', 'Hydrostatic pressure testing to 1.5x rated pressure'],
    pitfalls: ['VCR female nut threads must be coated with silver-based anti-seize to prevent galling at torque >20Nm', 'Micro-gasket flatness must be <0.01mm for reliable UHV knife-edge sealing — never re-use after compression', 'All blind-hole screws must be center-vented (gun-drilled) to eliminate virtual leaks — trapped air pockets outgas at 10^-9 Torr and prevent reaching base pressure'],
    specNote: 'ASTM B348 Grade 2 (UHP melt) / Grade 5, electropolished, 100% He leak tested + PMI certified, Class 100 packaged, center-vented per SEMI F1 for virtual leak elimination',
    servicePage: '/titanium-cnc-machining-services/custom-industrial-components/',
    image: '🔧',
  },
  {
    keywords: ['vacuum', 'seal', '密封', 'O-ring', 'O圈', 'Conflat', 'CF', 'KF', 'ISO', 'flange', 'clamp', 'gate valve', 'slit', 'retainer', 'window'],
    industries: ['Semiconductor'],
    category: 'UHV Sealing Rings & Chamber Compression Hardware',
    geometry: 'KF/ISO centering rings, segmented circular clamping rings, Conflat knife-edge rings, O-ring groove retainers, vented vacuum screws, high-load flange washers, gate valve seal retainers, oval slit-valve bezels, quartz window retaining bezels, split-ring quick-release segments',
    painPoints: ['Micro-leaks from uneven clamp load distribution across large flanges', 'Knife-edge dulling after repeated copper gasket compression cycles', 'Virtual leaks from trapped air in blind bolt holes', 'Aluminum scratching during wafer cleaning cycles', 'Thermal expansion mismatch between quartz windows and metal retainers'],
    alloyId: 'tc4',
    alloyReason: 'Grade 5 (Ti-6Al-4V) for Conflat knife-edge rings, clamping rings, and vented screws requiring high hardness and strength. Grade 2 for centering rings and retainers requiring low cost and corrosion resistance.',
    formId: 'bar',
    formReason: 'Bar/ring forgings for circular sealing components. Plate for slit-valve bezels and window retainers. All sealing surfaces require single-point diamond turning for mirror finish.',
    process: ['CNC turning of ring profiles and knife-edges', 'Single-point diamond turning of sealing surfaces', 'Center-boring of vented vacuum screws', 'Electropolishing of all vacuum-facing surfaces'],
    tollServices: ['Helium leak testing (1x10^-10 mbar.L/s)', 'Knife-edge profile inspection (optical microscopy)', 'Surface roughness measurement (Ra<0.05um on knife-edge)', 'Dimensional certification of bolt circle patterns'],
    pitfalls: ['Conflat knife-edge angle must be 60 degrees +-0.5 degrees with tip radius <0.002mm for reliable copper gasket bite', 'Vented vacuum screw center hole depth must exceed thread length to ensure trapped air can escape before final拧紧'],
    specNote: 'ASTM B348 Grade 5 (rings/screws) / Grade 2 (retainers), diamond-turned sealing surfaces, 100% He leak tested',
    servicePage: '/titanium-cnc-machining-services/custom-industrial-components/',
    image: '🔄',
  },
  {
    keywords: ['plasma', '等离子', 'shield', 'liner', 'baffle', 'chamber', 'etch', '刻蚀', 'CVD', 'deposition', 'sputter', '溅射', 'shadow ring', 'grounding', 'semiconductor'],
    industries: ['Semiconductor'],
    category: 'Plasma Chamber Liners, Shields & Thermal Hardware',
    geometry: 'Rough-bead-blasted chamber wall liners, exhaust plenum baffle plates, ceramic heater clamping plates, slit-valve protection shunts, shield stand-off bushings, threaded blind studs, arc-shaped shadow ring brackets, RF grounding spring fingers, thermocouple shielding caplets',
    painPoints: ['Plasma erosion of chamber walls causing metal contamination', 'Deposition film flaking from liners causing particle defects', 'Thermal shock from rapid temperature cycling during processing', 'RF grounding contact degradation at elevated temperature', 'Thread seizure in chamber interior fasteners exposed to halogen plasma'],
    alloyId: 'cp2',
    alloyReason: 'Grade 2 (CP-Ti) for plasma liners, baffles, and shields — excellent plasma erosion resistance and film adherence with bead-blasted surface. Grade 5 for clamping plates, shadow ring brackets, and studs requiring high strength. Nitinol/Beta-Ti for RF grounding spring fingers requiring high-temperature spring retention.',
    formId: 'plate',
    formReason: 'Plate/sheet for liners, baffles, and shields via waterjet/laser cutting + forming. Bar for stand-offs and studs. Wire forming for spring fingers. Bead blasting of plasma-facing surfaces for film adhesion.',
    process: ['Waterjet/laser cutting of liner profiles', 'Bead blasting of plasma-facing surfaces', 'CNC machining of clamping plates and brackets', 'TIG welding of shield assemblies (back-side only to avoid weld spatter on plasma face)'],
    tollServices: ['Surface roughness measurement of bead-blasted surface (Ra 3-6um)', 'Plasma erosion testing (customer-specified recipe)', 'Dimensional inspection of mating surfaces', 'Cleanroom packaging (Class 100)'],
    pitfalls: ['Bead-blasted surface must be free of embedded alumina media — use glass bead or Ti powder blasting only', 'RF spring finger contact force must be >50g at 200C operating temperature to maintain low-impedance ground path'],
    specNote: 'ASTM B265 Grade 2 (liners) / ASTM B348 Grade 5 (hardware), bead-blasted plasma face, Class 100 cleaned',
    servicePage: '/titanium-cnc-machining-services/custom-industrial-components/',
    image: '💡',
  },
  {
    keywords: ['metrology', '计量', 'optical', '光学', 'laser', 'mirror', 'lens', 'mass spec', 'quadrupole', 'pressure transducer', 'diaphragm', 'fiber optic', 'shutter', 'electron', 'aperture', 'prism', 'Faraday', 'instrument'],
    industries: ['Semiconductor'],
    category: 'Precision Instrumentation & Optical Metrology Components',
    geometry: 'Laser mirror gimbal mounts, optical lens retaining rings, quadrupole mass spec rod alignment rings, ultra-thin pressure transducer diaphragms, fiber-optic feedthrough ferrules, piezo-actuator screws, ultra-lightweight shutter blades, electron beam aperture disks, angled prism mounting wedges, micro-vibration isolation leaf springs, PEEK-insulated hybrid bolts, Faraday cup housing caps',
    painPoints: ['Thermal drift causing laser beam deviation of fractions of a degree', 'Magnetic field distortion from ferrous components in e-beam and mass spec systems', 'Micro-vibration transmitted from pumps/buildings affecting sub-nanometer measurements', 'Diaphragm hysteresis causing pressure sensor drift over time', 'Outgassing from polymer components in UHV metrology chambers'],
    alloyId: 'tc4',
    alloyReason: 'Grade 5 (Ti-6Al-4V) for optical mounts, lens rings, alignment rings, shutter blades, aperture disks — non-magnetic, low thermal expansion, high rigidity. Beta-Ti/ Nitinol for leaf springs and diaphragms requiring superelasticity and zero hysteresis.',
    formId: 'bar',
    formReason: 'Bar stock for optical mounts and sensor components via ultra-precision CNC machining. Sheet as thin as 0.1mm for shutter blades and diaphragms via chemical etching or wire EDM. Beta-Ti wire for leaf springs.',
...

  {
    ...
    painPoints: ['Radiation-induced embrittlement of conventional alloys in neutron flux fields', 'Flow-accelerated corrosion (FAC) of carbon steel in high-velocity steam/water', 'Hydrogen embrittlement of steel at 700+ bar hydrogen pressure', 'Cryogenic brittleness of standard steel at -253C liquid hydrogen temperature', 'Alpha case formation during hot forming causing premature fatigue failure', 'Galvanic corrosion at dissimilar metal junctions in desalination brine streams'],
    alloyId: 'cp2',
    alloyReason: 'Grade 2 CP-Ti for condenser tubes, fuel pool racks, and desalination piping — complete immunity to seawater and radiation. Grade 5 (Ti-6Al-4V) for steam generator nozzles, ECCS valve stems, spent fuel cask bolts. Grade 23 ELI for hydrogen storage valve stems and cryogenic LH2 flange bolts — Fe <=0.20% required to prevent hydrogen embrittlement. Grade 12 for radioactive waste evaporators requiring high-temp crevice corrosion resistance.',
    formId: 'tube',
    formReason: 'Seamless tube extrusion for condenser tubes and steam generator coils. Bar stock via gun drilling for valve stems. Hot forging + thread rolling for cask bolts and cryogenic flange bolts. Sheet stamping for fuel pool rack spacers. Powder metallurgy sintering for flame arrestor disks. All hydrogen-service components must be vacuum heat treated to remove alpha case.',
    process: ['Continuous cold tube pilgering for condenser tubes', 'Hot forging + vacuum annealing of valve stems and bolts', 'Deep-hole gun drilling of gas manifold blocks', 'Powder sintering of flame arrestor porous disks', '7-stage UHP cleanroom wash for hydrogen fuel cell components'],
    tollServices: ['100% eddy current testing (ECT) of condenser tubes', 'Helium leak testing of hydrogen components (1x10^-9 mbar.L/s)', 'Gas chromatography for hydrogen embrittlement certification (H<125ppm)', 'Charpy impact testing at -253C for LH2 cryogenic hardware', 'Micro-CT of flame arrestor pore structure', '3.1 MTC with VAR ingot traceability per ASME Section VIII'],
    pitfalls: ['Condenser tube wall thickness tolerance +-0.05mm for 40-year nuclear service life — pitting >0.1mm depth is rejectable', 'Hydrogen storage valve stems must have Fe <=0.20% verified by OES/GDMS — standard Grade 5 (Fe 0.40%) is unacceptable for H2 service', 'Spent fuel cask bolts require Charpy V-notch >27J at -40C — titanium does not embrittle, but weld overlay must be verified'],
    specNote: 'ASTM B338 Grade 2 (condenser tubes) / ASTM B348 Grade 23 ELI (H2 service) / ASTM B348 Grade 5 (cask bolts), vacuum annealed, 100% ECT + He leak tested, 3.1 MTC per ASME Section VIII',
    servicePage: '/titanium-fabrication-services/titanium-welding-assembly/',
    image: '⚡',
  },
