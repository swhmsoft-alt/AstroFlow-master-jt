...
const PART_DB: PartProfile[] = [
  ...
  },
  {
    ...
    pitfalls: ['VCR female nut threads must be coated with silver-based anti-seize to prevent galling at torque >20Nm', 'Micro-gasket flatness must be <0.01mm for reliable UHV knife-edge sealing — never re-use after compression'],
    specNote: 'ASTM B348 Grade 2 (UHP melt) / Grade 5, electropolished, 100% He leak tested + PMI certified, Class 100 packaged',
    servicePage: '/titanium-cnc-machining-services/custom-industrial-components/',
    image: '🔧',
  },
  {
  ...
  },
  {
    ...
    specNote: 'ASTM B348 Grade 5 ELI / Beta-Ti per customer spec, ultra-precision machined, 100% CMM + magnetic permeability tested',
    servicePage: '/titanium-cnc-machining-services/custom-industrial-components/',
    image: '🔍',
  },
