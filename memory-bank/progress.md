...
## Pending
- [ ] `git push`（HEAD 含本次改动未推送到 origin/main）
- [ ] 生产部署本次改动（`npm run deploy:inc`）
- [ ] 既有 6 个 React 组件类型错误专项修复（FacilityStats/StatsCards/UseCaseTabs ts(2769)、UseCaseTabs ts(2322)、ReverseEngineerTool ts(2345) ×2）
