/**
 * Add SLM/3d-printing-slm page translations to all 9 language files
 * Run: node scripts/translate-slm-all.mjs
 */
import fs from 'fs';
...
// English fallback
const fallback = `  "services.slmprocessbreakdown.badge": "SLM Process Mechanics",
