/**
 * Translate FabSpecsDashboard keys for all 8 target languages using DeepSeek API.
 */
import fs from 'fs';
...
RULES:
- Keep technical terms/acronyms unchanged: TIG, CNC, LPM, O₂, NDT, RT, UT, PT, AWS, ASME
- Keep measurement units and values unchanged: "0.5 mm", "20 mm+", "99.999%", "98%"
