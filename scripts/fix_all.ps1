Write-Host "Restoring all modified source files from git HEAD..."
$files = @(
...
Write-Host "`nRestored $count files."
Write-Host "Now run: node scripts/translate-hardcoded-text.mjs --apply"