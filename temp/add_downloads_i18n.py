...
keys = {
    'resources.engineeringdownloads.badge': 'Engineering Downloads',
    'resources.engineeringdownloads.titlePrefix': 'Technical',
    'resources.engineeringdownloads.titleHighlight': 'Resource Library',
    'resources.engineeringdownloads.description': 'Downloadable engineering assets — CAD models, property datasheets, and manufacturing reference booklets. All files are production-grade and revision-controlled.',
}
...
for lang, lname in lang_list:
    ...
    body = json.dumps({
        'model': 'deepseek-chat',
        'messages': [
            {'role': 'system', 'content': f'Translate JSON from English to {lname} for website. Keep keys. Valid JSON.'},
