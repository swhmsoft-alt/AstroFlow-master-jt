...
print(f'Found {len(keys)} grade whyChooseUs keys')
...
for lang in langs:
    ...
    body = json.dumps({
        'model': 'deepseek-chat',
        'messages': [
            {'role': 'system', 'content': f'You are a professional {lang_names[lang]} translator for industrial manufacturing content. Translate the following JSON values from English to {lang_names[lang]}. Keep keys unchanged. Return ONLY valid JSON.'},
