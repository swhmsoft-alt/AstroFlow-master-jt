...
keys = {
    'resources.resourcehubmatrix.badge': 'Resource Index',
    'resources.resourcehubmatrix.titlePrefix': 'Content',
    'resources.resourcehubmatrix.titleHighlight': 'Hub Matrix',
    'resources.resourcehubmatrix.description': 'Six core resource categories engineered for rapid technical discovery — from material science fundamentals to advanced manufacturing case studies.',
}
...
for lang in langs:
    ...
    body = json.dumps({
        'model': 'deepseek-chat',
        'messages': [
            {'role': 'system', 'content': f'Translate JSON values from English to {lang_names[lang]} for website. Keep keys. Return valid JSON.'},
